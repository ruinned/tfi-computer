...
struct table ve_vs_rpm_and_map __attribute__((section(".configdata"))) = {
  ...
  .data = {
    .two = {
      ...
      {65.0,  45.0,  65.0,  49.0,  50.0,  55.0,  58.0,  58.0,  58.0,  63.0,  64.0,  65.0,  68.0,  68.0,  68.0,  68.0},
      {65.0,  45.0,  65.0,  63.0,  63.0,  65.0,  67.0,  67.0,  67.0,  68.0,  68.0,  68.0,  70.0,  70.0,  70.0,  72.0},
      {65.0,  45.0,  65.0,  63.0,  63.0,  65.0,  70.0,  70.0,  80.0,  72.0,  72.0,  72.0,  77.0,  77.0,  78.0,  78.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  80.0,  80.0,  80.0,  80.0,  80.0,  80.0,  80.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  90.0,  93.0,  94.0,  94.0,  94.0,  94.0,  94.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  90.0,  93.0,  94.0,  94.0,  94.0,  94.0,  94.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  90.0,  93.0,  94.0,  94.0,  94.0,  94.0,  94.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  90.0,  93.0,  94.0,  94.0,  94.0,  94.0,  94.0},
      {65.0,  45.0,  65.0,  63.0,  65.0,  70.0,  80.0,  82.0,  90.0,  90.0,  93.0,  94.0,  94.0,  94.0,  94.0,  94.0},
...
struct config config __attribute__((section(".configdata"))) = {
  ...
  .sensors = {
    ...
    [SENSOR_AAP] = {.source=SENSOR_CONST, .params={.fixed_value = 100.0}},
