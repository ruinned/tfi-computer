...
struct table ve_vs_rpm_and_map __attribute__((section(".configdata"))) = {
  ...
  .data = {
   ...
   /*  250,   500,   900,  1200,  1600,   2000,  2400,  3000, 3600,  4000,   4400,  5200,  5800,  6400,  6800,  7200}, */
      {65.0,  30.0,  8.0,   10.0,   10.0,   10.0,   11.0,   11.0,  11.0,   14.0,  16.0,  16.0,  16.0,  16.0,  16.0,  16.0}, /* 20 */
      {65.0,  45.0,  7.0,   13.0,   9.0, 12.0,   12.0,  13.0,  13.0,  20.0,  25.0,  25.0,  26.0,  26.0,  26.0,  26.0}, /* 30 */ 
      {65.0,  45.0,  23.0,  23.0,  26.0,  24.0,  27.0,  28.0,  28.0,  39.0,  40.0,  43.0,  45.0,  45.0,  45.0,  45.0}, /* 40 */ 
      {65.0,  45.0,  50.0,  42.0,  38.0,  37.0,  39.0,  39.0,  35.0,  46.0,  48.0,  50.0,  52.0,  52.0,  52.0,  52.0}, /* 50 */ 
      {65.0,  45.0,  55.0,  53.0,  48.0,  46.0,  49.0,  48.0,  60.0,  58.0,  52.0,  52.0,  52.0,  52.0,  52.0,  52.0}, /* 60 */ 
      {65.0,  45.0,  63.0,  56.0,  53.0,  53.0,  58.0,  56.0,  67.0,  66.0,  66.0,  66.0,  67.0,  67.0,  67.0,  67.0}, /* 70 */ 
      {65.0,  45.0,  72.0,  60.0,  65.0,  66.0,  74.0,  66.0,  67.0,  70.0,  70.0,  70.0,  70.0,  68.0,  68.0,  68.0}, /* 80 */ 
      {65.0,  45.0,  72.0,  72.0,  79.0,  80.0,  87.0,  78.0,  80.0,  83.0,  80.0,  80.0,  70.0,  70.0,  70.0,  72.0}, /* 90 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  91.0,  84.0,  90.0,  85.0,  85.0,  85.0,  77.0,  77.0,  78.0,  78.0}, /* 100 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  96.0,  91.0,  95.0,  85.0,  85.0,  85.0,  80.0,  80.0,  80.0,  80.0}, /* 120 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 140 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 160 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 180 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 200 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 220 */ 
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0,  100.0}, /* 240 */ 
    },
  },
};
...
struct table boost_control_pwm __attribute__((section(".configdata"))) = {
  ...
  .data = {
    .one = {0.55, 0.55, 0.55, 0.55, 0.55, 0.55},
  },
};
